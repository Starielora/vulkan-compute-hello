...
int main()
{
    ...
    const auto severityFlags = vk::DebugUtilsMessageSeverityFlagsEXT(vk::DebugUtilsMessageSeverityFlagBitsEXT::eWarning | vk::DebugUtilsMessageSeverityFlagBitsEXT::eError | vk::DebugUtilsMessageSeverityFlagBitsEXT::eInfo | vk::DebugUtilsMessageSeverityFlagBitsEXT::eVerbose);
    const auto messageTypeFlags = vk::DebugUtilsMessageTypeFlagsEXT(vk::DebugUtilsMessageTypeFlagBitsEXT::eGeneral | vk::DebugUtilsMessageTypeFlagBitsEXT::ePerformance | vk::DebugUtilsMessageTypeFlagBitsEXT::eValidation);
    const auto debugMessenger = instance.createDebugUtilsMessengerEXT({ {}, severityFlags, messageTypeFlags, &debugCallback });
    ...
    const auto prio = vk::ArrayProxy<const float>{ 1.0f };
    const auto compute_queue_create_info = vk::DeviceQueueCreateInfo({}, compute_family_index, prio);
